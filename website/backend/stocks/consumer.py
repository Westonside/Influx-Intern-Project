...
# from .models import BuySellNotification, User

# @database_sync_to_async
# def create_notification(receiver,status="unread"):
#     notification_to_create=BuySellNotification.objects.create(user_revoker=receiver)
